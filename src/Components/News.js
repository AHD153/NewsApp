...
export class News extends Component {
    ...
    // To use props you have to pass the props in constructor
    // constructor(props) {
    //     super(props);

    //     this.state = {
    //         articles: [],
    //         loading: false, // False for the buttons next and previous
    //         page: 1,
    //         totalResults: 0
    //     }

    //     document.title = `${this.capitalizeFirstLetter(this.props.category)} - ADNews`;
    // }
    ...
    // This is a second Method to update News
    ...
    // This is a first Method to update News
    ...
    render() {
        return (
            <>
                <h1 className='text-center' style={{ margin: "35px 0" }}>ADNews - Top {this.capitalizeFirstLetter(this.props.category)}  Headlines</h1>
                ...
                {/* This is for pre. and next buttons. */}
